...
public class BalanceSheet implements Serializable {
     ...
     * 合同资产
     */
    @JSONField(name = "contract_assets")
     ...
     * 一年内到期的非流动资产
     */
    @JSONField(name = "non_current_asset_due_year")
    private double nonCurrentAssetDueYear;
     ...
     * 其他债权投资
     */
    @JSONField(name = "other_debt_investment")
    private double otherDebtInvestment;


    /**
     * 长期应收款
     */
    @JSONField(name = "long_term_receivables")
    ...
    private double otherNonCurrentNets;
